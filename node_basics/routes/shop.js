...
//         path: '/',
//         pathTitle: 'Shop'
//     }); //res.render is used to render the templating file it will have first argument as the file name and the other arguments are the arguments of the feature which we give to render dynamic template
